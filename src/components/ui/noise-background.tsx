...
export const NoiseBackground = ({
  ...
  useAnimationFrame((time) => {
    ...
    const dtMs = Math.min(32, Math.max(0, time - lastFrameTimeRef.current));
    lastFrameTimeRef.current = time;
    ...
    let newX = currentX + velocityRef.current.x * dtMs;
    let newY = currentY + velocityRef.current.y * dtMs;
