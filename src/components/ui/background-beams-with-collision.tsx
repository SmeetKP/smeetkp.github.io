...
// Deterministic pseudo-random based on index (avoids Math.random during render)
...
const Explosion = ({
  ...
  // Pre-compute deterministic values based on index
  const spans = Array.from({ length: 20 }, (_, index) => ({
    id: index,
    initialX: 0,
    initialY: 0,
    directionX: Math.floor(seededValue(index, 1) * 80 - 40),
    directionY: Math.floor(seededValue(index, 2) * -50 - 10),
    duration: seededValue(index, 3) * 1.5 + 0.5,
  }));
